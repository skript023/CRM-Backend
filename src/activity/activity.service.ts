...
export class ActivityService 
{
    ...
    {
        const activities = await this.activityModel.find(null, { createdAt: 0, updatedAt: 0, __v: 0 }).
    ...
    {
        const res = await this.activityModel.findById(id, { createdAt: 0, updatedAt: 0, __v: 0 }).populate('user', ['fullname', 'username'])
